...
<br>Xiao Wu*, Alan Romano, Liyan Huang, Qiwen Yan, Cai Fu, Weihang Wang.
<br><font color="#ac2669" size="2">[WWW'26]</font> In Proceedings of the 35th International World Wide Web Conference.

- **Is Your Benchmark (Still) Useful? Dynamic Benchmarking for Code Language Models**
<br>Batu Guan, Xiao Wu*, Yuanyuan Yuan, Shaohua Li.
<br><font color="#ac2669" size="2">[DL4C@NeurIPS]</font> The 4th Deep Learning for Code Workshop @ NeurIPS, 2025.
...
<div style="display: flex; flex-wrap: wrap;">
  <div style="flex: 1; min-width: 250px; margin-right: 40px;">
    ...
    <ul>
      ...
      <li>2021 - University Scholarship for Merit Students</li>
      <li>2021 - Outstanding Student Club Officer</li>
      <li>2020 - Excellent Student Association Cadre</li>
    </ul>
  </div>
  <div style="flex: 1; min-width: 250px;">
    <h3>Competition:</h3>
    <ul>
      <li>2022 - "China Software Cup" Software Design Competition - National Second Prize</li>
      <li>2021 - National Student Information Security Competition - National First Prize - Team Leader</li>
    </ul>
  </div>
</div>
